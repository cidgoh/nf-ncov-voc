...
def parse_args():
    ...
    # mutually exclusive: input file is either a GVF or functional_annotations
    group = parser.add_mutually_exclusive_group()
    group.add_argument('--ingvf', type=str, default=None,
                        help='Path to the GVF file output of vcf2gvf.py')
    group.add_argument('--functional_annotations', type=str,
...
if __name__ == '__main__':
    ...
    elif args.functional_annotations!=None:
