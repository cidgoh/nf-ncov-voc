process DOWNLOAD_VIRALAI_MULTIFASTA {
    ...
    """
        ...
        dnastack collections query ${params.viralai_collection_slug_name} "SELECT * FROM viralai.${params.viralai_collection_slug_name}.files WHERE NAME LIKE 'CanCOGeN/multifasta_compressed/%' ORDER BY created_time DESC LIMIT 1" | jq -r '.[].drs_url' > test.txt
