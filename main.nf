...
// import subworkflows
include {ncov_voc} from './workflows/Variantcalling.nf'
...
workflow {
      ...
      //Channel.from('B.1.1.7', 'B.1.351', 'B.1.427', 'B.1.429', 'P.1', 'B.1.525', 'B.1.526', 'B.1.526.1', 'B.1.526.2', 'B.1.617', 'P.2')
      //      .set{ch_voc}
      Channel.from('B.1.617', 'P.1' )
            .set{ch_voc}
