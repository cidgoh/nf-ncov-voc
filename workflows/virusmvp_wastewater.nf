...
workflow WASTEWATER {
    ...
    BAM_VARIANT_DEMIX_BOOT_FREYJA(WW_SAMTOOLS_SORT.out.bam, file(params.viral_genome), params.freyja_boot_depthcutoff, params.db_name, ch_barcodes, ch_lineages_meta)
